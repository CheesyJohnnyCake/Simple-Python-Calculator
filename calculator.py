...
def addition_character(button_function_addition):
    question_input.insert(tkinter.END, str('+'))
...
def multiplication_character(button_function_multiplication):
    question_input.insert(tkinter.END, str('x'))
...
def one_character(button_function_one):
    question_input.insert(tkinter.END, str('1'))
...
def two_character(button_function_two):
    question_input.insert(tkinter.END, str('2'))
...
def three_character(button_function_three):
    question_input.insert(tkinter.END, str('3'))
...
def four_character(button_function_four):
    question_input.insert(tkinter.END, str('4'))
...
def five_character(button_function_five):
    question_input.insert(tkinter.END, str('5'))
...
def six_character(button_function_six):
    question_input.insert(tkinter.END, str('6'))
...
def seven_character(button_function_seven):
    question_input.insert(tkinter.END, str('7'))
...
def eight_character(button_function_eight):
    question_input.insert(tkinter.END, str('8'))
...
def nine_character(button_function_nine):
    question_input.insert(tkinter.END, str('9'))
...
def zero_character(button_function_zero):
    question_input.insert(tkinter.END, str('0'))
...
def solve():
    ...
    e = eval(e)
    question_input.delete(0, tkinter.END)
    question_input.insert(tkinter.END, str(e))
...
def pi_character(button_function_pi):
    question_input.insert(tkinter.END, str('π'))
...
# GUI
button_zero = tkinter.Button(window, text='0', fg='black', bd=1, bg="gainsboro", width=5, padx=4, pady=5)
button_one = tkinter.Button(window, text='1', fg='black', bd=1, bg='gainsboro', width=5, padx=4, pady=5)
button_two = tkinter.Button(window, text='2', fg='black', bd=1, bg='gainsboro', width=5, padx=4, pady=5)
button_three = tkinter.Button(window, text='3', fg='black', bd=1, bg='gainsboro', width=5, padx=4, pady=5)
button_four = tkinter.Button(window, text='4', fg='black', bd=1, bg='gainsboro', width=5, padx=4, pady=5)
button_five = tkinter.Button(window, text='5', fg='black', bd=1, bg='gainsboro', width=5, padx=4, pady=5)
button_six = tkinter.Button(window, text='6', fg='black', bd=1, bg='gainsboro', width=5, padx=4, pady=5)
button_seven = tkinter.Button(window, text='7', fg='black', bd=1, bg='gainsboro', width=5, padx=4, pady=5)
button_eight = tkinter.Button(window, text='8', fg='black', bd=1, bg='gainsboro', width=5, padx=4, pady=5)
button_nine = tkinter.Button(window, text='9', fg='black', bd=1, bg='gainsboro', width=5, padx=4, pady=5)
button_decimal = tkinter.Button(window, text='.', fg='black', bd=1, bg='gray', width=5, padx=4, pady=5)
button_pi = tkinter.Button(window, text='π', fg='black', bd=1, bg='gray', width=5, padx=4, pady=5)
...
add_button = tkinter.Button(window, text='+', fg='black', bd=1, bg='gray', width=5, padx=4, pady=5)
button_function_addition()

subtract_button = tkinter.Button(window, text='-', fg='black', bd=1, bg='gray', width=5, padx=4, pady=5)
button_function_subtraction()

divide_button = tkinter.Button(window, text='÷', fg='black', bd=1, bg='gray', width=5, padx=4, pady=5)
button_function_division()

multiply_button = tkinter.Button(window, text='x', fg='black', bd=1, bg='gray', width=5, padx=4, pady=5)
button_function_multiplication()

percent_button = tkinter.Button(window, text='%', fg='black', bd=1, bg='gray', width=5, padx=4, pady=5)
button_function_percent()

square_root_button = tkinter.Button(window, text='√', fg='black', bd=1, bg='gray', width=5, padx=4, pady=5)
button_function_square_root()

square_button = tkinter.Button(window, text='x²', fg='black', bd=1, bg='gray', width=5, padx=4, pady=5)
...
clear_button = tkinter.Button(window, text='CE', fg='black', bd=1, bg='gray', width=5, padx=4, pady=5)
clear_button.place(x=0, y=98)
button_function_clear()

question_input = tkinter.Entry(window, width=31)
question_input.place(x=0, y=78)

answer_button = tkinter.Button(window, text='=', fg='black', bd=1, bg='gray64', width=26, command=solve, padx=4, pady=5)
